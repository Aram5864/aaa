...
class ContactController extends Controller
{
    public function submit(RequestsContactRequest $req){
        ...
        return redirect()->route('contact-data')->with('success',"Ձեր հաղորդագրությունը հաջողությամբ գնաց");
    ...
    public function deleteData($id)
    {
        ...
        return redirect()->route('contact-data')->with('success',"Delete Complate!");
    }
}
